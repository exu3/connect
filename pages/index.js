      ...
      <main>
        <section>
          <div className="text-center">
            ...
            <h1 className="text-5xl font-extrabold font-montserrat bg-clip-text text-transparent bg-gradient-to-r from-[#C67DFF] to-[#497CFF] text-shadow-lg text-shadow-blue dark:text-shadow-white">Command Connect</h1>
